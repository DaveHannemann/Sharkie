class EndScreen extends DrawableObject {
  ...
  initWinScreen() {
    ...
    this.animatedButtons = [
      ...
      this.createStaticButton(
        ...
        40,
        40,
        ["img/6.Botones/shell_home.png"],
        "Home",
      ),
    ];
    if (this.onNextLevel) {
      this.animatedButtons.push(
        this.createStaticButton("nextLevel", 640, 420, 60, 60, [
          "img/6.Botones/next_level.png",
        ]),
      );
    }
  }
  ...
  isMouseOverButton(mouseX, mouseY) {
    return this.animatedButtons.some((btn) =>
      this.isPointInsideButton(btn, mouseX, mouseY),
    );
  }
  ...
  isPointerButtonHovered(mouseX, mouseY) {
    ...
    return this.animatedButtons.some(
      (btn) =>
        pointerBtns.includes(btn.name) &&
        this.isPointInsideButton(btn, mouseX, mouseY),
    );
  }
